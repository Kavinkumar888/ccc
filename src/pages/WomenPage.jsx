...
const WomenPage = () => {
  ...
  const filteredProducts = selectedCategory === 'All'
    ? productsData.women
    : productsData.women.filter(product => product.category === selectedCategory);

  const subcategories = [
    { name: 'All', icon: <FiTag size={18} /> },
    { name: 'Sarees', icon: <FiBox size={18} /> },
                  ...
                  <li
                    ...
                    className={`flex items-center cursor-pointer px-4 py-3 rounded-xl transition-all duration-300 ${
                      selectedCategory === subcategory.name
                        ...
                        : 'text-gray-700 hover:bg-pink-50 hover:text-pink-600 hover:shadow-md'
                    }`}
                  >
          ...
          <div className="lg:w-3/4 w-full">
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-800 mb-2">
                {selectedCategory === 'All' ? 'All Women Products' : selectedCategory}
              </h1>
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-lg hover:shadow-lg transform hover:scale-105 transition-all duration-300 font-medium"
                        >
                          Add to Cart
                        </button>
                      </div>
