...
const TraditionalWearPage = () => {
  ...
  const traditionalProducts = allProducts.filter(
    (product) => product.category === 'Traditional Wear'
  );

  // Subcategories list (you can customize these)
  const subcategories = [
    { name: 'All', icon: <RiShirtFill /> },
  ];
  ...
  const filteredProducts =
    selectedCategory === 'All'
      ? traditionalProducts
      : traditionalProducts.filter((p) => p.type === selectedCategory);
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Explore our exquisite collection of traditional Indian wear, crafted
            with premium fabrics and authentic designs.
          </p>
        </div>
                  ...
                  <li
                    ...
                    className={`flex items-center cursor-pointer px-4 py-3 rounded-xl transition-all duration-300 ${
                      selectedCategory === subcategory.name
                        ...
                        : 'text-gray-700 hover:bg-amber-50 hover:text-amber-600 hover:shadow-md'
                    }`}
                  >
            ...
            <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center">
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  {selectedCategory !== 'All' && (
                    <span className="ml-2">(Category: {selectedCategory})</span>
                  )}
                </p>
              </div>
            </div>
            ...
            {filteredProducts.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <button
                  ...
                  className="mt-4 px-6 py-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-lg hover:shadow-lg transition-all duration-300 font-medium"
                >
                  Reset Filters
                </button>
              </div>
